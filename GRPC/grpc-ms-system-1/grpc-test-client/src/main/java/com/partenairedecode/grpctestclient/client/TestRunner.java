...
import com.partenairedecode.grpctestclient.service.TestClientService;
...
public class TestRunner implements CommandLineRunner {
  ...
  private final TestClientService clientService;

  public TestRunner(TestClientService clientService) {
  ...
  public void runIntegrationTest() throws Exception {
    System.out.println("====================================================");
    System.out.println("   STARTING MICROSERVICE INTEGRATION TESTS");
    System.out.println("====================================================");

    // --- TEST 1: EXISTING PRODUCT (Assuming product ID 1 exists after data initialization) ---
    String existingProductId = "1";
    clientService.testInternalGrpc(existingProductId);
    clientService.testExternalHttp(existingProductId);

    // --- TEST 2: NON-EXISTENT PRODUCT (To test exception handling) ---
    String nonExistentProductId = "999";
    clientService.testInternalGrpc(nonExistentProductId);
    clientService.testExternalHttp(nonExistentProductId);
